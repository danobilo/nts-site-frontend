  ...
  <header class="site-header navbar-sticky">
    ...
    <div class="topbar d-flex justify-content-between">
      ...
      <div class="site-branding d-flex">
        <router-link
          to="/"
          class="site-logo align-self-center"
        >
          <img
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    ...
                    >
                      <img
                        class="d-block"
                        src="img/shop/header-categories/03.jpg"
                      ><span
                        class="text-gray-dark"
                      >
                        TV, Video &amp; Audio
                  ...
                  <div class="col-sm-3">
                    ...
                    >
                      <img
                        class="d-block"
                        src="img/shop/header-categories/04.jpg"
                      ><span
                        class="text-gray-dark"
                      >
                        Cameras, Photo &amp; Video
                ...
                <div class="row">
                  <div class="col-sm-3">
                    ...
                    >
                      <img
                        class="d-block"
                        src="img/shop/header-categories/05.jpg"
                      ><span
                        class="text-gray-dark"
                      >
                        Headphones
                  ...
                  <div class="col-sm-3">
                    ...
                    >
                      <img
                        class="d-block"
                        src="img/shop/header-categories/06.jpg"
                      ><span
                        class="text-gray-dark"
                      >
                  ...
                  <div class="col-sm-3">
                    ...
                    >
                      <img
                        class="d-block"
                        src="img/shop/header-categories/07.jpg"
                      ><span
                        class="text-gray-dark"
                      >
                        Printers &amp; Ink
                  ...
                  <div class="col-sm-3">
                    ...
                    >
                      <img
                        class="d-block"
                        src="img/shop/header-categories/08.jpg"
                      ><span
                        class="text-gray-dark"
                      >
                        Video Game
      ...
      <div class="toolbar d-flex">
        <div class="toolbar-item visible-on-mobile mobile-menu-toggle">
          <a href="#">
            <div>
              <i class="icon-menu" /><span class="text-label">
                Menu
              </span>
            </div>
          </a>
          ...
          <a href="product-comparison.html">
            <div>
              <span class="compare-icon">
                <i class="icon-repeat" /><span class="count-label">
                  3
                </span>
              </span><span
                class="text-label"
        ...
        >
          <router-link to="/login">
            <div>
              <i class="icon-user" /><span class="text-label">
                Sign In / Up
              </span>
            </div>
          </router-link>
          <div class="toolbar-dropdown text-center px-3">
            <p class="text-xs mb-3 pt-2">
              Sign in to your account or register new one to have full control
              over your orders, receive bonuses and more.
            </p>
            <router-link
              to="/login"
          ...
          <router-link to="/cart">
            <div>
              <span class="cart-icon">
                <i class="icon-shopping-cart" /><span
                  class="count-label"
                >
                  3
                </span>
          ...
          >
              ...
              <ul class="slideable-submenu">
                ...
                <li class="has-children">
                  ...
                  <ul class="slideable-submenu">
                    ...
                    <li>
                      <a href="shop-grid-rs.html">
                        Grid Right Sidebar
                      </a>
                    </li>
                    <li>
                      <a href="shop-grid-ns.html">
                        Grid No Sidebar
                      </a>
                    </li>
                  </ul>
                ...
                <li class="has-children">
                  ...
                  <ul class="slideable-submenu">
                    ...
                    <li>
                      <a href="shop-list-rs.html">
                        List Right Sidebar
                      </a>
                    </li>
                    <li>
                      <a href="shop-list-ns.html">
                        List No Sidebar
                      </a>
                    </li>
                  </ul>
            ...
            <li class="has-children">
              ...
              <ul class="slideable-submenu">
                ...
                <li>
                  <a href="account-open-ticket.html">
                    Open Ticket
                  </a>
                </li>
                <li>
                  <a href="account-tickets.html">
                    My Tickets
                  </a>
                </li>
                <li>
                  <a href="account-single-ticket.html">
                    Single Ticket
                  </a>
                </li>
              </ul>
              ...
              <ul class="slideable-submenu">
                ...
                <li class="has-children">
                  ...
                  <ul class="slideable-submenu">
                    ...
                    <li>
                      <a href="blog-single-ls.html">
                        Post Left Sidebar
                      </a>
                    </li>
                    <li>
                      <a href="blog-single-ns.html">
                        Post No Sidebar
                      </a>
                    </li>
                  </ul>
            ...
            <li class="has-children">
              ...
              <ul class="slideable-submenu">
                ...
                <li>
                  <a href="components/shop-items.html">
                    Shop Items
                  </a>
                </li>
                <li>
        ...
        <ul>
          ...
          <li class="has-megamenu">
            ...
            <ul class="mega-menu">
              ...
              <li>
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    <ul class="list-icon">
                      <li>
                        <i class="icon-map-pin text-muted" />514 S. Magnolia St. Orlando, FL
                        32806, USA
                      </li>
                      <li><i class="icon-phone text-muted" />+1 (786) 322 560 40</li>
                      <li class="mb-0">
                        <i class="icon-mail text-muted" /><a
                          class="navi-link"
                ...
                <div class="card">
                  <div class="card-body">
                    <ul class="list-icon">
                      <li>
                        <i class="icon-map-pin text-muted" />44 Shirley Ave. West Chicago, IL
                        60185, USA
                      </li>
                      <li><i class="icon-phone text-muted" />+1 (847) 252 765 33</li>
                      <li class="mb-0">
                        <i class="icon-mail text-muted" /><a
                          class="navi-link"
              ...
              <li>
                <a
                  class="card border-0 bg-secondary rounded-0"
                  href="shop-grid-ls.html"
                >
                  <img
                    class="d-block mx-auto"
                    alt="Samsung Galaxy S9"
                    src="img/banners/mega-menu.jpg"
                  >
                </a>
              </li>
            </ul>
