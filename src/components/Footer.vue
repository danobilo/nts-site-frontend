  ...
  >
    <div class="container">
            ...
            <ul class="list-unstyled text-sm text-white">
              <li>
                <span class="opacity-50">
                  Monday-Friday:&nbsp;
                </span>9.00 am - 8.00 pm
              </li>
              <li>
                <span class="opacity-50">
                  Saturday:&nbsp;
                </span>10.00 am - 6.00 pm
              </li>
            </ul>
            <p>
              <a
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <section class="widget widget-light-skin">
            <h3 class="widget-title">
              ...
              class="market-button apple-button mb-light-skin"
              href="#"
            >
              <span class="mb-subtitle">
                Download on the
              </span><span class="mb-title">
                App Store
              </span>
            </a><a
            ...
            >
              ...
              class="market-button windows-button mb-light-skin"
              href="#"
            >
              <span class="mb-subtitle">
                Download on the
          ...
          <section class="widget widget-light-skin">
            ...
            <div class="pt-3">
              <img
                ...
                style="width: 324px;"
                alt="Cerdit Cards"
                src="img/credit-cards-footer.png"
              >
            </div>
          </section>
        </div>
      ...
      <p class="footer-copyright">
        © All rights reserved. Made with &nbsp;<i class="icon-heart text-danger" /><a
          href="http://rokaux.com/"
          target="_blank"
        >
          &nbsp;by rokaux
        </a>
