<template>
  <div>
          ...
          <div class="container padding-top-3x">
            <div class="row justify-content-center align-items-center">
              <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                <div class="from-bottom">
                  <img
                    class="d-inline-block w-150 mb-3"
          ...
          <div class="card border-0 bg-secondary mb-30">
            <div class="card-body d-table w-100">
              <div class="d-table-cell align-middle">
                <img
                  class="d-block w-100"
                  src="img/shop/categories/29.png"
                  alt="Image"
                >
              </div>
              <div class="d-table-cell align-middle pl-2">
                ...
                <h4 class="h6 d-table w-100 text-thin">
                  <span
                    class="d-table-cell align-bottom"
                    style="line-height: 1.2;"
                  >
                    UP<br>TO&nbsp;
                  </span><span
                    class="d-table-cell align-bottom h1 text-medium"
                  >
                    50%
                  </span><span
                    class="d-table-cell align-bottom"
                ...
                >
                  Shop now&nbsp;<i
                    class="icon-chevron-right d-inline-block align-middle text-lg"
                  />
                </a>
              </div>
            </div>
          ...
          <div class="card border-0 bg-secondary mb-30">
            <div class="card-body d-table w-100">
              <div class="d-table-cell align-middle">
                <img
                  class="d-block w-100"
                  src="img/shop/categories/30.png"
                  alt="Image"
                >
              </div>
              <div class="d-table-cell align-middle pl-2">
                <h3 class="h6 text-thin">
                  ...
                  >
                    HD Video Drone
                  </span> <br><strong>Arrives</strong>
                </h3>
                <h4 class="h6 d-table w-100 text-thin">
                  <span
                    class="d-table-cell align-top text-right"
                    style="line-height: 1.2;"
                  >
                    From&nbsp;<br><strong>$&nbsp;</strong>
                  </span><span
                    class="d-table-cell align-top h1 text-medium"
                  >
                    990
                  </span>
                </h4><a
          ...
          <div class="card border-0 bg-secondary mb-30">
            <div class="card-body d-table w-100">
              <div class="d-table-cell align-middle">
                <img
                  class="d-block w-100"
                  src="img/shop/categories/31.png"
                  alt="Image"
                >
              </div>
              <div class="d-table-cell align-middle pl-2">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="product-card mb-30">
            ...
            <div class="product-button-group">
              <a
                class="product-button btn-wishlist"
                href="#"
              >
                <i
                  class="icon-heart"
                ...
                class="product-button btn-compare"
                href="#"
              >
                <i
                  class="icon-repeat"
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="product-card mb-30">
            <div class="rating-stars">
              <i class="icon-star filled" /><i class="icon-star filled" /><i
                class="icon-star filled"
              /><i class="icon-star filled" /><i class="icon-star" />
            </div>
            <a
              class="product-thumb"
              href="shop-single.html"
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="product-card mb-30">
            <div class="rating-stars">
              <i class="icon-star filled" /><i class="icon-star filled" /><i
                class="icon-star filled"
              /><i class="icon-star" /><i class="icon-star" />
            </div>
            <a
              class="product-thumb"
              href="shop-single.html"
    ...
    <!-- CTA-->
    <section
      class="fw-section padding-top-4x padding-bottom-8x"
      style="background-image: url(img/banners/shop-banner-bg-02.jpg);"
    >
      <span
        class="overlay"
        style="opacity: .7;"
      ...
      <div class="container text-center">
        <div class="d-inline-block bg-danger text-white text-lg py-2 px-3 rounded">
          Limited Time Offer
        </div>
        <div class="display-4 text-white py-4">
          Ultimate Printing Solution From
        </div>
        <div class="d-inline-block w-200 pt-2">
          <img
            class="d-block w-100"
            src="img/banners/shop-banner-logo.png"
            alt="Canon"
          >
        </div>
        <div class="pt-5" />
        <div
          class="countdown countdown-inverse"
    ...
    <a
      class="d-block position-relative mx-auto"
      href="shop-grid-ls.html"
      style="max-width: 682px; margin-top: -130px; z-index: 10;"
    >
      <img
        class="d-block w-100"
        src="img/banners/shop-banner-02.png"
        alt="Printers"
      >
    </a>
    <!-- Staff Picks (Widgets)-->
    ...
    <section class="bg-secondary padding-top-3x padding-bottom-3x">
      <div class="container">
        <h2 class="h3 text-center mb-30 pb-3">
          Popular Brands
        </h2>
        <div
          class="owl-carousel"
